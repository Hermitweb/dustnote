...
export const config = {
  ...
  serverVersion: getEnv('SERVER_VERSION', '2.0.0'),
  minClientVersion: getEnv('MIN_CLIENT_VERSION', '2.0.0'),
  recommendedClientVersion: getEnv('RECOMMENDED_CLIENT_VERSION', '2.0.0'),
