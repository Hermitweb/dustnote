 ...
 *
 * Tauri 环境下 GitHub 链接通过 opener 插件在系统默认浏览器中打开，
 * 而非在 WebView 内导航（WebView 无法打开外部 HTTPS 链接）。
 */
    ...
    >
      ...
      >
        ...
        <a
          ...
          onClick={(e) => {
            e.preventDefault();
            void openExternalUrl('https://github.com/Hermitweb/dustnote');
          }}
          className="mt-3 flex cursor-pointer items-center justify-center gap-2 rounded-lg border border-surface-border bg-surface-bg px-4 py-2.5 text-sm font-medium text-surface-fg transition-colors hover:bg-surface-border"
        >
