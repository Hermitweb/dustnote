          ...
          <div className="max-h-[70vh] space-y-5 overflow-y-auto pr-1">
            ...
            <div>
              ...
              <div className="space-y-2">
                ...
                <button
                  ...
                  disabled={pwBusy}
                  className="w-full rounded-lg bg-mint-600 px-3 py-2 text-sm font-medium text-on-accent hover:bg-mint-700 disabled:opacity-50"
                >
            ...
            <div>
              ...
              <div className="flex gap-2">
                ...
                <button
                  ...
                  className="rounded-lg bg-mint-600 px-3 py-2 text-sm font-medium text-on-accent transition-colors hover:bg-mint-700"
                >
                  ...
                  {updateState === 'available' && targetVer && (
                    <div className="flex items-center justify-between text-sm">
                      ...
                      <button
                        ...
                        className="rounded bg-mint-600 px-3 py-1 text-xs font-medium text-on-accent hover:bg-mint-700"
                      >
                        {t('settings.download')}
                      </button>
                    </div>
            ...
            <div className="rounded-lg border border-surface-border p-3 text-xs text-surface-muted">
              ...
              {pwaInstall.canInstall && (
                <button
                  className="mt-2 rounded-md bg-mint-500 px-3 py-1.5 text-xs font-medium text-on-accent hover:bg-mint-600"
