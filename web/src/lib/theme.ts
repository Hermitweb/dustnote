...
> = {
  'mint-dawn': {
    light: {
      '--mn-bg': '246 246 242',
      '--mn-fg': '28 33 29',
      '--mn-fg-muted': '92 100 93',
      '--mn-border': '231 233 226',
      '--mn-card': '255 255 255',
      '--mn-accent': '10 122 18',
      '--mn-accent-fill': '18 217 30',
      '--mn-accent-fg': '8 38 10',
      '--mn-accent-soft': '233 255 234',
    },
    dark: {
      '--mn-bg': '17 20 18',
      '--mn-fg': '233 237 233',
      '--mn-fg-muted': '140 150 142',
      '--mn-border': '38 43 39',
      '--mn-card': '26 31 28',
      '--mn-accent': '124 255 133',
      '--mn-accent-fill': '18 217 30',
      '--mn-accent-fg': '8 38 10',
      '--mn-accent-soft': '15 42 18',
    },
  },
  'mist-blue': {
    light: {
