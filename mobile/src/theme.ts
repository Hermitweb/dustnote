...
const THEME_PALETTES: Record<ThemeId, { light: ThemePalette; dark: ThemePalette }> = {
  'mint-dawn': {
    light: { bg: '#F7FAF7', card: '#FFFFFF', fg: '#1E293B', muted: '#64748B', border: '#E2E8F0', accent: '#16A34A', accentSoft: '#DCFCE7' },
    dark: { bg: '#0F172A', card: '#1E293B', fg: '#E2E8F0', muted: '#94A3B8', border: '#334155', accent: '#4ADE80', accentSoft: '#14532D' },
  },
  'mist-blue': {
    light: { bg: '#F1F5F9', card: '#FFFFFF', fg: '#0F172A', muted: '#475569', border: '#CBD5E1', accent: '#3B82F6', accentSoft: '#DBEAFE' },
    dark: { bg: '#0F172A', card: '#1E293B', fg: '#E2E8F0', muted: '#94A3B8', border: '#334155', accent: '#60A5FA', accentSoft: '#1E3A8A' },
  },
  'dusk-forest': {
    light: { bg: '#F5F6F0', card: '#FFFFFF', fg: '#1D2924', muted: '#576056', border: '#D7DED1', accent: '#657B4E', accentSoft: '#E6EEDA' },
    dark: { bg: '#141E18', card: '#202D24', fg: '#DCE6D7', muted: '#94A390', border: '#323C32', accent: '#94B871', accentSoft: '#374E29' },
  },
  'caramel-warm': {
    light: { bg: '#FCF8F3', card: '#FFFAF0', fg: '#3F2719', muted: '#78604E', border: '#E9DCC6', accent: '#B45309', accentSoft: '#FEF3C7' },
    dark: { bg: '#1C1610', card: '#2D231A', fg: '#F0E6D7', muted: '#B4A082', border: '#3C3226', accent: '#D97706', accentSoft: '#5A320C' },
  },
  'sakura-pink': {
    light: { bg: '#FDF4F7', card: '#FFFAFC', fg: '#4C2132', muted: '#9C6E7C', border: '#F5D7E2', accent: '#DB507C', accentSoft: '#FCE8F0' },
    dark: { bg: '#1C1418', card: '#2A1E24', fg: '#F0D7DE', muted: '#B48C98', border: '#3C2832', accent: '#F472B6', accentSoft: '#701A3C' },
  },
  'minimal-white': {
    light: { bg: '#FFFFFF', card: '#FAFAFA', fg: '#171717', muted: '#737373', border: '#E5E5E5', accent: '#171717', accentSoft: '#F5F5F5' },
    dark: { bg: '#0A0A0A', card: '#171717', fg: '#F0F0F0', muted: '#8C8C8C', border: '#323232', accent: '#F0F0F0', accentSoft: '#3C3C3C' },
  },
};
